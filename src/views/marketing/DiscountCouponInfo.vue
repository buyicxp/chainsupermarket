	...
	<div>
		...
		<div class="table">
			<el-table :data="tableData" style="width: 100%">
				...
				<el-table-column label="优惠券名称" width="130">
					<template slot-scope="scope">
				...
				<el-table-column label="操作">
					<template slot-scope="scope">
						...
						<el-button size="mini" type="warning" @click="getTheTecord(scope.$index, scope.row)">领取记录</el-button>
					</template>
				</el-table-column>
			</el-table>
		</div>
